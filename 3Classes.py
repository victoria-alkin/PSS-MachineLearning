...
training_in_file = open(r"C:\Users\victoria.alkin\Documents\Machine Learning 2\Sets\training_in_3.pkl","rb")
training_in_db = pickle.load(training_in_file)
training_in_file.close()
training_out_file = open(r"C:\Users\victoria.alkin\Documents\Machine Learning 2\Sets\training_out_3.pkl","rb")
training_out_db = pickle.load(training_out_file)
training_out_file.close()
training_in_df = pd.DataFrame(training_in_db, columns=['x','y'])
...
testing_in_file = open(r"C:\Users\victoria.alkin\Documents\Machine Learning 2\Sets\testing_in_3.pkl","rb")
testing_in_db = pickle.load(testing_in_file)
testing_in_file.close()
testing_out_file = open(r"C:\Users\victoria.alkin\Documents\Machine Learning 2\Sets\testing_out_3.pkl","rb")
testing_out_db = pickle.load(testing_out_file)
testing_out_file.close()
testing_in_df = pd.DataFrame(testing_in_db, columns=['x','y'])
...
for i, clf in enumerate((linsvc, svclink, svcrbfk, svcpolyk)):
    ...
    plt.scatter(v3features[:,0], v3features[:,1],s=0.5,alpha=0.2,figure=figure)

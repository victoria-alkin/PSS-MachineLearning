...
training_in_file = open(r"Data\Sets\training_in_8.pkl","rb")
training_in_db = pickle.load(training_in_file)
training_in_file.close()
training_out_file = open(r"Data\Sets\training_out_8.pkl","rb")
...
testing_in_file = open(r"C:\Users\victoria.alkin\Documents\Machine Learning 2\Sets\testing_in_8.pkl","rb")
testing_in_db = pickle.load(testing_in_file)
testing_in_file.close()
testing_out_file = open(r"C:\Users\victoria.alkin\Documents\Machine Learning 2\Sets\testing_out_8.pkl","rb")
...
classnames = ["spine", "shaft", "soma", "proximal process", "partial spine", "merged shaft"]
